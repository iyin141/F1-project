...
from api.session.serializers import SectorAnalysisResponseSerializer
import traceback
...
def populate_sector_analysis(self, task_key: str, year: int, round_number: int, session_type: str, **kwargs):
    """
    Compute sector analysis (best sectors, theoretical best lap) for a race session.
    """
    ...
    try:
        from api.services.analysis import get_sector_analysis
