...
class Race(models.Model):
	...
	event_format = models.CharField(max_length=120, null=True, blank=True)
	session1 = models.CharField(max_length=120, null=True, blank=True)
	session1_date_utc = models.DateTimeField(null=True, blank=True)
	session2 = models.CharField(max_length=120, null=True, blank=True)
	session2_date_utc = models.DateTimeField(null=True, blank=True)
	session3 = models.CharField(max_length=120, null=True, blank=True)
	session3_date_utc = models.DateTimeField(null=True, blank=True)
	session4 = models.CharField(max_length=120, null=True, blank=True)
	session4_date_utc = models.DateTimeField(null=True, blank=True)
	session5 = models.CharField(max_length=120, null=True, blank=True)
	session5_date_utc = models.DateTimeField(null=True, blank=True)
