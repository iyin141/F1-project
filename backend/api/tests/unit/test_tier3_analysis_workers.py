...
class TestPopulatePaceAnalysisWorker(TestCase):
    ...
    def test_populate_pace_analysis_returns_structured_data(self, mock_get_pace, mock_handle_result):
        ...
        mock_get_pace.return_value = {'meta': {'year': 2023, 'round': 4, 'session': 'R', 'can_proceed': True, 'row_count': 2, 'limit_max': 1000}, 'filters_applied': {}, 'data': [{'driver_code': 'VER', 'driver_number': 1, 'laps_completed': 57, 'session_median_lap_seconds': 95.5, 'laps_completed': 50, 'consistency_stddev_seconds': 0.42, 'fastest_lap_seconds': 94.1}, {'driver_code': 'HAM', 'driver_number': 44, 'laps_completed': 57, 'session_median_lap_seconds': 96.2, 'consistency_stddev_seconds': 0.55, 'fastest_lap_seconds': 95.8}]}
    ...
    def test_populate_pace_analysis_caches_result(self, mock_get_pace, mock_handle_result):
        ...
        mock_get_pace.return_value = {'meta': {'year': 2023, 'round': 4, 'session': 'R', 'can_proceed': True, 'row_count': 2, 'limit_max': 1000}, 'filters_applied': {}, 'data': [{'driver_code': 'VER', 'session_median_lap_seconds': 95.5, 'laps_completed': 50}]}
        populate_pace_analysis(task_key='mock', year=2023, round_number=4, session_type='R')
        mock_handle_result.assert_called_once()
        result = mock_handle_result.call_args[1]['serialized_data']
...
class TestPopulateStintAnalysisWorker(TestCase):
    ...
    def test_populate_stint_analysis_returns_structured_data(self, mock_get_stints, mock_handle_result):
        ...
        mock_get_stints.return_value = {'meta': {'year': 2023, 'round': 4, 'session': 'R', 'can_proceed': True, 'row_count': 2, 'limit_max': 1000}, 'filters_applied': {}, 'data': [{'driver_code': 'VER', 'driver_number': 1, 'stint_number': 1, 'compound': 'SOFT', 'lap_start': 1, 'lap_end': 20, 'total_laps': 20, 'laps_in_stint': 20, 'median_lap_seconds': 95.8, 'min_lap_seconds': 94.1, 'max_lap_seconds': 98.5}, {'driver_code': 'VER', 'driver_number': 1, 'stint_number': 2, 'compound': 'MEDIUM', 'lap_start': 21, 'lap_end': 57, 'total_laps': 37, 'laps_in_stint': 37, 'median_lap_seconds': 95.2, 'min_lap_seconds': 94.8, 'max_lap_seconds': 96.1}]}
    ...
    def test_populate_stint_analysis_includes_tyre_info(self, mock_get_stints, mock_handle_result):
        ...
        mock_get_stints.return_value = {'meta': {'year': 2023, 'round': 4, 'session': 'R', 'can_proceed': True, 'row_count': 2, 'limit_max': 1000}, 'filters_applied': {}, 'data': [{'driver_code': 'HAM', 'compound': 'HARD', 'lap_start': 1, 'lap_end': 30, 'laps_in_stint': 30}]}
        populate_stint_analysis(task_key='mock', year=2023, round_number=4, session_type='R')
        mock_handle_result.assert_called_once()
        result = mock_handle_result.call_args[1]['serialized_data']
        assert 'data' in result
...
class TestPopulateSectorAnalysisWorker(TestCase):
    ...
    def test_populate_sector_analysis_returns_structured_data(self, mock_get_sectors, mock_handle_result):
        ...
        mock_get_sectors.return_value = {'meta': {'year': 2023, 'round': 4, 'session': 'R', 'can_proceed': True, 'row_count': 2, 'limit_max': 1000}, 'filters_applied': {}, 'data': [{'driver_code': 'VER', 'driver_number': 1, 'laps_count': 10, 'best_sector1_seconds': 30.111, 'best_sector2_seconds': 35.222, 'best_sector3_seconds': 28.333, 'median_sector1_seconds': 30.444, 'median_sector2_seconds': 35.555, 'median_sector3_seconds': 28.666, 'best_lap_seconds': 93.9, 'theoretical_best_lap_seconds': 93.666, 'delta_to_theoretical_seconds': 0.234}, {'driver_code': 'HAM', 'driver_number': 44, 'laps_count': 10, 'best_sector1_seconds': 30.889, 'best_sector2_seconds': 36.111, 'best_sector3_seconds': 28.945, 'median_sector1_seconds': 31.222, 'median_sector2_seconds': 36.333, 'median_sector3_seconds': 29.111, 'best_lap_seconds': 95.0, 'theoretical_best_lap_seconds': 94.667, 'delta_to_theoretical_seconds': 0.333}]}
    ...
    def test_populate_sector_analysis_includes_best_lap(self, mock_get_sectors, mock_handle_result):
        ...
        mock_get_sectors.return_value = {'meta': {'year': 2023, 'round': 4, 'session': 'R', 'can_proceed': True, 'row_count': 2, 'limit_max': 1000}, 'filters_applied': {}, 'data': [{'driver_code': 'VER', 'best_lap_seconds': 93.9, 'theoretical_best_lap_seconds': 93.666, 'laps_count': 10}]}
        populate_sector_analysis(task_key='mock', year=2023, round_number=4, session_type='R')
        mock_handle_result.assert_called_once()
        result = mock_handle_result.call_args[1]['serialized_data']
        assert 'data' in result
...
class TestPopulateTyreStrategyWorker(TestCase):
    ...
    def test_populate_tyre_strategy_returns_structured_data(self, mock_get_tyre_strategy, mock_handle_result):
        ...
        mock_get_tyre_strategy.return_value = {'meta': {'year': 2023, 'round': 4, 'session': 'R', 'can_proceed': True, 'row_count': 2, 'limit_max': 1000}, 'filters_applied': {}, 'data': [{'driver_code': 'VER', 'driver_number': 1, 'stint_number': 1, 'compound': 'SOFT', 'lap_start': 1, 'lap_end': 20, 'total_laps': 20, 'laps_in_stint': 20}, {'driver_code': 'VER', 'driver_number': 1, 'stint_number': 2, 'compound': 'MEDIUM', 'lap_start': 21, 'lap_end': 57, 'total_laps': 37, 'laps_in_stint': 37}]}
    ...
    def test_populate_tyre_strategy_aggregates_stints(self, mock_get_stints, mock_handle_result):
        ...
        mock_get_stints.return_value = {'meta': {'year': 2023, 'round': 4, 'session': 'R', 'can_proceed': True, 'row_count': 2, 'limit_max': 1000}, 'filters_applied': {}, 'data': [{'driver_code': 'HAM', 'compound': 'SOFT', 'total_laps': 20}, {'driver_code': 'HAM', 'compound': 'HARD', 'total_laps': 37}]}
        populate_tyre_strategy(task_key='mock', year=2023, round_number=4, session_type='R')
        mock_handle_result.assert_called_once()
        result = mock_handle_result.call_args[1]['serialized_data']
        assert 'data' in result
