...
def safe_int_param(value: str | None, name: str) -> int | None:
    """
    Parse an optional query-parameter string to int.

    Returns None when *value* is None or empty.
    Raises ValueError with a user-friendly message when the value is not numeric.
    """
